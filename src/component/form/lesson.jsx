                ...
                <div className="container mt-5 ">
                  <form className="col g-3 d-flex-column justify-content-center" onSubmit={e => this.submit(e)}>
                    ...
                    <div className="col-md-5 m-1 d-flex align-items-end">
                      <Input type="file" name="file" label="File Pdf" />
                      <span><button type="button" className="btn btn-outline-dark ms-2">Remove <RemoveCircleOutlineIcon /> </button></span>
                      <div><button type="button" className="btn btn-outline-dark ms-2">Add <AddCircleOutlineIcon /> </button></div>
                    </div>
                    <div className="col-md-5 m-1">
