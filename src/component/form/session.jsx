      ...
      <>
        <div className="container mt-5 ">
          ...
          <form className="col g-3 d-flex-column justify-content-center" onSubmit={this.props.name === "add" ? (e) => this.props.create(e, "sessions") : (e) => this.props.update(e, "sessions")}>
            ...
            <Select onChange={this.props.onChange} name="volunteer" resource="volunteer" resourceArray={this.props.volunteers} resourceProperty="name" value={this.props.temporary.volunteer} />
